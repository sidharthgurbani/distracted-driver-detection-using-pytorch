...
def parse_args():
    ...
    # path
    parser.add_argument('--data_path', default='/home/gurbani/Downloads/dataset/driver', type=str,
                        help='Driver data directory path')
    parser.add_argument('--root_path', default='/home/gurbani/pytorch/learn/DriverPostureClassification', type=str,
