"""
Divide the dataset into 2 parts only, i.e. train set and test set.
"""
...
if __name__ == '__main__':
    driver = Driver('/home/gurbani/Downloads/dataset/driver', train=True)
    print(driver.__getitem__(1))
    print(driver.__len__())  # 12977
    driver = Driver('/home/gurbani/Downloads/dataset/driver', train=False, test=True)
